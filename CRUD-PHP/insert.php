    ...
    <div class="container position-absolute top-50 start-50 translate-middle">
        <form method="POST">
            <div class="mb-3">
                ...
                <input required name="nis" type="text" class="form-control" id="nis">
            </div>
            <div class="mb-3">
                ...
                <div class="form-check">
                    <input value="P" class="form-check-input" type="radio" name="jenis_kelamin" id="flexRadioDefault2" checked>
